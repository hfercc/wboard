...
def serialize_models(obj):
	...
	if isinstance(obj, JsonObjectModel):
		obj = obj.get_json_object()
	elif isinstance(obj, models.query.QuerySet):
		obj = list(obj)
	elif is_user_instance(obj):
		return obj.profile.get_json_object()
